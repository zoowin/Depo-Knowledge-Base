# Product Image URLs — Klaviyo CDN

> Last updated: 2026-03-17
> Source: Klaviyo image library (d3k81ch9hvuctc.cloudfront.net)
> Usage: Copy URL directly into email HTML `<img src="...">` tags

---

## Style 1: Pure Product PNG (Transparent Background)

| # | Product Name | Line | SKU Reference | Image URL |
|---|-------------|------|---------------|-----------|
| 1 | Matriplex Cream | A — Matrixyl® | Matriplex Cream | `https://d3k81ch9hvuctc.cloudfront.net/company/XbHdQN/images/420e0d8e-091d-4a94-ad76-e4c2bea97c46.png` |
| 2 | Body Lotion | C — Retinoid | Retinoid Body Lotion | `https://d3k81ch9hvuctc.cloudfront.net/company/XbHdQN/images/65227851-df6d-4cbd-bcae-6a5c9e446619.png` |
| 3 | Triple Lipid Cream | H — Barrier Repair | Triple Lipid + Q10 | `https://d3k81ch9hvuctc.cloudfront.net/company/XbHdQN/images/f11a370d-d5dc-426a-90b0-1ec12a1f8c85.png` |
| 4 | Blue Under Eye Patch | B — Argireline™ | Micro-dart Patch | `https://d3k81ch9hvuctc.cloudfront.net/company/XbHdQN/images/fb01a6c6-6cdf-4159-b40b-9f605f71ab65.png` |
| 5 | Matrixyl 3000 Serum | A — Matrixyl® | Collagen Serum | `https://d3k81ch9hvuctc.cloudfront.net/company/XbHdQN/images/44a0bdde-9c05-4c2b-854b-fe92895a2a6f.png` |
...
## Style 2: (Pending — Leon to provide)

_Reserved for lifestyle/scene product images._
...
| Asset | URL |
|-------|-----|
| Dēpology Logo | `https://d3k81ch9hvuctc.cloudfront.net/company/XbHdQN/images/82cac524-3eb2-4807-a508-af61cee50920.png` |
...
- **Cica Serum (#11) 已停产**，不应在 EDM 中作为推荐产品使用
- Style 1 为 PNG 透明底，适合深色背景邮件模板
- 后续 Leon 会提供其他风格的产品图（如场景图、lifestyle 等）
- 使用时直接复制 URL，不需要重新上传到 Klaviyo
